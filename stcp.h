 ...
 * State types
 */
#define STCP_LISTEN      0x0
#define STCP_ESTABLISHED 0x1
#define STCP_CLOSED      0x2
#define STCP_TIME_WAIT   0x3
#define STCP_TIME_WAIT_2 0x4
#define STCP_RESET       0x5
